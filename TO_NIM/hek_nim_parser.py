...
def to_nim(self, indent=0):
    """compound_stmt: if_stmt | while_stmt | for_stmt | try_stmt | with_stmt | case_stmt | func_def | class_def | decorated_def | async_func_def | async_for_stmt | async_with_stmt | shell_stmt"""
    return self.nodes[0].to_nim(indent)
...
def to_nim(self, indent=0):
    ...
    _returns_string = _ret_pyc.lstrip(": ").strip() in ("string", "cstring")
